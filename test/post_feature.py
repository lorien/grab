...
class TestPostFeature(TestCase):
    ...
    def test_post(self):
        ...
        g.request()
        self.assertEqual(SERVER.REQUEST['post'], 'Привет, мир!')

        # Two values with one key
        g.setup(post=(('foo', 'bar'), ('foo', 'baz')))
        g.request()
        self.assertEqual(SERVER.REQUEST['post'], 'foo=bar&foo=baz')
    ...
    def test_multipart_post(self):
        ...
        g.request()
        self.assertTrue('name="foo"' in SERVER.REQUEST['post'])
