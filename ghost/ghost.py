...
class Ghost(object):
    ...
    #def unsupported_content(self, rep):
        #self.unsupported_contents.append(rep)
    ...
    def __init__(self, user_agent=default_user_agent, wait_timeout=8,
        ...
        #self.page.unsupportedContent.connect(self.unsupported_content)
    ...
    def wait_for_page_loaded(self):
        ...
        for resource in resources:
            print 'A', self.main_frame.url().toString()
            print 'B', resource.url
            if self.main_frame.url().toString() == resource.url:
                page = resource
        #if not page:
            #for res in self.unsupported_contents:
                #if res.url
